 ...
 */
@WebServlet("/servletApplication")// This is URL Mapping(Which page we need to display when executed)
public class servletApplication extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//below code used to make application that work like google search engine
